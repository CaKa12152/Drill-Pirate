...
from drill_writer.core.timing import local_tempo, set_index_for_count, transition_end_count
...
def collision_motion_context(
    ...
    set_end = transition_end_count(project, set_index)
    ...
    def normalized_window(dot_id: str) -> tuple[tuple[float, float], float]:
        move_start, move_end = motion_window_for_dot(drill_set, dot_id, set_end)
        return (
            (
